...
@Composable
fun MoviePager(modifier: Modifier) {
        ...
        HorizontalPager(
            ...
            Box(
                modifier = Modifier
                    ...
                    .graphicsLayer {
                        val startOffset = horizontalState.currentPage
        ...
        Row(
            ...
            LaunchedEffect(Unit) {
                snapshotFlow {
                    ...
                    verticalState.scrollToPage(page, 1F)
                }
            }
            ...
            val interpolatedRating by remember {
                derivedStateOf {
                    val position =
                        horizontalState.currentPage + horizontalState.currentPage
